...
<div className="row mb-3 pt-5 align-items-center">
  ...
  <div className="col-sm-7">
    <img className="w-100 img-fluid" src="Images/Home/Multicountry.png" alt=""/>
  </div>
...
{/* <!----------------HR---------------------> */}
  ...
  <div className="container">
    ...
    <div className="row mb-3 pt-5 pb-4">
      ...
      <div className="col-sm-7 lead"><img className="w-100 img-fluid" src="Images/Money Scanner/userflowchart.png" alt=""/>
      </div>
    </div>

    <div className="row mb-3 pt-5 pb-4">
      <div className="col-sm-5 pb-3 h3">Data Flow Diagram Map</div>
      <div className="col-sm-7 lead"><img className="w-100 img-fluid" src="Images/Money Scanner/dataflow.png" alt=""/></div>
    </div>

    <div className="row mb-3 pt-5 pb-4">
      <div className="col-sm-5 pb-3 h3">Sample UI</div>
      <div className="col-sm-7"><img className="w-100 img-fluid" src="Images/Home/Multicountry.png" alt=""/></div>
    </div>

    <div className="row mb-3 pt-5 pb-4">
      <div className="col-sm-5 pb-3 h3">Tech Stack</div>
      <div className="col-sm-7"><img className="w-100 img-fluid" src="Images/Money Scanner/techstack.png" alt=""/></div>
    </div>
    ...
    <div className="row mb-3 pt-5 pb-4">
     ...
     <div className="col-sm-7">
        ...
        <img src="Images/Money Scanner/videolink.png" className="w-100 img-fluid card-img-top" alt="target"/>
...
<a href="https://drive.google.com/file/d/1B9nJtNgija1KmFyWMD65QyPjvy4iC5V2/view?usp=sharing" target="_blank"
  className="stretched-link"></a>
    ...
    {/* <div className="col-sm-7">
        <div className="card" style="width: 100%;">
          <img src="Projects/Money Scanner/videolink.png" className="w-100 img-fluid card-img-top" alt="target"/>
