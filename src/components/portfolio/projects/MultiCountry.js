...
<div class="row mb-3 pt-5 align-items-center">
  ...
  <div class="col-sm-7">
    <img class="w-100 img-fluid" src="Images/Home/Multicountry.png" alt=""/>
  </div>

  <div class="row mb-3">
    <div class="col-sm-12 pt-5">
      <p class="lead">"Money Companion" was made because some people may not be able to see anymore but that does
        not
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-4">
      ...
      <div class="row small">
        <div class="col-md-12">
          <p class="text-muted">Xamarin Forms</p>
        </div>
        <p class="text-muted">Azure Cognitive Services</p>
        <p class="text-muted pb-3">Firebase Cloud Storage</p>
      </div>
    </div>
    ...
    <div class="col-md-8">
      ...
      <div class="row small">
        <div class="col-md-12">
          <p class="text-muted">February 2021 - January 2022</p>
        </div>
      </div>
    </div>
  </div>
...
{/* <!----------------HR---------------------> */}
  ...
  <div class="container">
    ...
    <div class="row mb-3 pt-5 pb-4">
      <div class="col-sm-5 pb-3 h3">Struggles Encountered / Solutions</div>
      <div class="col-sm-7">
        <p class="lead">First and foremost is budget, the system we developed supports 3 currencies and it is
        ...
        <p class="lead"> The second problem we encountered was we almost ran out of time, it is because we've done a lot
          of trial and
        ...
        <p class="lead">From Android Studio and teachable ml, we moved to use Visual Studio Xamarin and Azure Cognitive
          Services "we are
          ...
          the
          model training.</p>
        <p class="lead"> The application right now stopped operating it is because we end our subscriptions in Azure, we
    ...
    <div class="row mb-3 pt-5 pb-4">
      <div class="col-sm-5 pb-3 h3">Supported Currencies</div>
      <div class="col-sm-7 lead">Japan Yen, United States Dollars, Philippine Peso</div>
    </div>
    ...
    <div class="row mb-3 pt-5 pb-4">
      <div class="col-sm-5 pb-3 h3">User Flowchart Map</div>
      <div class="col-sm-7 lead"><img class="w-100 img-fluid" src="Images/Money Scanner/userflowchart.png" alt=""/>
      </div>
    </div>

    <div class="row mb-3 pt-5 pb-4">
      <div class="col-sm-5 pb-3 h3">Data Flow Diagram Map</div>
      <div class="col-sm-7 lead"><img class="w-100 img-fluid" src="Images/Money Scanner/dataflow.png" alt=""/></div>
    </div>

    <div class="row mb-3 pt-5 pb-4">
      <div class="col-sm-5 pb-3 h3">Sample UI</div>
      <div class="col-sm-7"><img class="w-100 img-fluid" src="Images/Home/Multicountry.png" alt=""/></div>
    </div>

    <div class="row mb-3 pt-5 pb-4">
      <div class="col-sm-5 pb-3 h3">Tech Stack</div>
      <div class="col-sm-7"><img class="w-100 img-fluid" src="Images/Money Scanner/techstack.png" alt=""/></div>
    </div>

    <div class="row mb-3 pt-5 pb-4">
      <div class="col-sm-5 pb-3 h3">Video Sample Link <p class="lead pt-2">Tap the image</p>
      </div>
    

     <div class="col-sm-7">
        <div class="card" style={{width: '100%'}}>
        <img src="Images/Money Scanner/videolink.png" class="w-100 img-fluid card-img-top" alt="target"/>
...
<a href="https://drive.google.com/file/d/1B9nJtNgija1KmFyWMD65QyPjvy4iC5V2/view?usp=sharing" target="_blank"
  class="stretched-link"></a>
    ...
    {/* <div class="col-sm-7">
        <div class="card" style="width: 100%;">
          <img src="Projects/Money Scanner/videolink.png" class="w-100 img-fluid card-img-top" alt="target"/>
    ...
    <div class="row mb-3">
      <div class="col-sm-12 pb-4 pt-5 lead">The data that we gathered strongly convince that Money Companion
        successfully
