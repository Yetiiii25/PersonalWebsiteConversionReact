...
<div class="row mb-3 pt-5 align-items-center">
  ...
  <div class="row mb-3">
    <div class="col-sm-12 pt-5">
      <p class="lead">This system was made for San Sebastian College - Recoletos Manila Clinic because they still
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-4">
      ...
      <div class="row small">
        <div class="col-md-12">
          <p class="text-muted">Window Forms</p>
        </div>
        <p class="text-muted">Ms Sql</p>
      </div>
    </div>
    ...
    <div class="col-md-8">
      ...
      <div class="row small">
        <div class="col-md-12">
          <p class="text-muted">February 2019 - January 2020</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="container">
<div class="row mb-3">
  <div class="col-sm-5 h3">Objectives</div>
  <div class="col-sm-7 lead">The general objectives of the study would likely focus on the Development of Patient
    ...
    <div class="row mb-3 pt-2">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">1.	Computerized Logging in and out from the clinic.</div>
    </div>

    <div class="row mb-3">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">2.	Summary of Patients that went in the clinic</div>
    </div>
    
    <div class="row mb-3">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">3.	Smart Search Functionality for faster data retrieval</div>
    </div>
    
    <div class="row mb-3">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">4.	Patient Information Table.</div>
    </div>

    <div class="row mb-3">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">5.	Annual Check-Up Records and Schedule.</div>
    </div>

    <div class="row mb-3">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">6.	Can set Notifications and Reminders.</div>
    </div>

    <div class="row mb-3">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">7.	Storages of Clinic documents and notes.</div>
    </div>

    <div class="row mb-3">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">8.	Identify and maintain a patient record.</div>
    </div>

    <div class="row mb-3">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">9.	Generate Patient Record.</div>
    </div>

    <div class="row mb-3">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">10.	Management of Patients Family Contact Information.</div>
    </div>

    <div class="row mb-3">
      <div class="col-sm-5 h3"></div>
      <div class="col-sm-7 lead">11.	Calendar Event.</div>
    </div>
...
<div class="row mb-3 pt-5 pb-4">
  ...
  <div class="col-sm-7 lead"> Full Stack Developer </div>
</div>

<div class="row mb-3 pt-5 pb-4">
  <div class="col-sm-5 h3">Tech Stack</div>
  <div class="col-sm-7 lead"><img class="w-100 img-fluid" src="Images//PIS/techstack.png" alt=""/>
  </div>
</div>

<div class="row mb-3 pb-4">
  <div class="col-sm-5 pb-3 h3"></div>
  <div class="col-sm-7 lead"> Windows Form was used for the Front-End and also C# for the Calendar Events while Ms Sql was used for the Back-End of the software
  </div>
</div>

<div class="row mb-3 pt-5 pb-4">
  <div class="col-sm-5 h3">Sample UI</div>
  <div class="col-sm-7 lead"><img class="w-100 img-fluid" src="Images//Home/Patientinfo.png" alt=""/>
  </div>
</div>

<div class="row mb-3 pt-5 pb-4">
  <div class="col-sm-5 h3">Database Schema</div>
  <div class="col-sm-7 lead"><img class="w-100 img-fluid" src="Images/PIS/database.png" alt=""/>
  </div>
</div>

<div class="row mb-3 pt-5 pb-4">
  <div class="col-sm-5 h3">Some Flowcharts</div>
  <div class="col-sm-7 lead"> 
   <div id="carouselExampleDark1" class="carousel carousel-dark slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        
      <div class="carousel-item active">
        <img src="Images/PIS/flowchart1.jpg" class="d-block w-100" alt="..."/>
      </div>
      <div class="carousel-item">
        <img src="Images/PIS/flowchart2.jpg" class="d-block w-100" alt="..."/>
      </div>
      <div class="carousel-item">
        <img src="Images/PIS/flowchart3.jpg" class="d-block w-100" alt="..."/>
      </div>
      <div class="carousel-item">
        <img src="Images/PIS/flowchart4.jpg" class="d-block w-100" alt="..."/>
      </div>
      <div class="carousel-item">
        <img src="Images/PIS/flowchart5.jpg" class="d-block w-100" alt="..."/>
      </div>
    </div>
...
<div class="row mb-3 pt-5 pb-4">
  <div class="col-sm-5 h3">Some Data Flow Diagram</div>
  <div class="col-sm-7 lead"> 
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="Images/PIS/dfd1.jpg" class="d-block w-100" alt="..."/>
      </div>
      <div class="carousel-item">
        <img src="Images/PIS/dfd2.jpg" class="d-block w-100" alt="..."/>
      </div>
      <div class="carousel-item">
        <img src="Images/PIS/dfd3.jpg" class="d-block w-100" alt="..."/>
      </div>
      <div class="carousel-item">
        <img src="Images/PIS/dfd4.jpg" class="d-block w-100" alt="..."/>
      </div>
      <div class="carousel-item">
        <img src="Images/PIS/dfd5.jpg" class="d-block w-100" alt="..."/>
      </div>
    </div>
