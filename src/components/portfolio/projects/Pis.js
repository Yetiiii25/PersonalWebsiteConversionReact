    ...
    <>
      ...
      <div className="container">
        ...
        <div className="row mb-3 pt-5 pb-4">
          ...
          <div className="col-sm-7 lead"><img className="w-100 img-fluid" src="Images//PIS/techstack.png" alt="" />
          </div>
        </div>
        ...
        <div className="row mb-3 pt-5 pb-4">
          ...
          <div className="col-sm-7 lead"><img className="w-100 img-fluid" src="Images//Home/Patientinfo.png" alt="" />
          </div>
        </div>
        <div className="row mb-3 pt-5 pb-4">
          <div className="col-sm-5 h3">Database Schema</div>
          <div className="col-sm-7 lead"><img className="w-100 img-fluid" src="Images/PIS/database.png" alt="" />
          </div>
        </div>
        <div className="row mb-3 pt-5 pb-4">
            ...
            <div id="carouselExampleDark1" className="carousel carousel-dark slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="Images/PIS/flowchart1.jpg" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src="Images/PIS/flowchart2.jpg" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src="Images/PIS/flowchart3.jpg" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src="Images/PIS/flowchart4.jpg" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src="Images/PIS/flowchart5.jpg" className="d-block w-100" alt="..." />
                </div>
              </div>
        ...
        <div className="row mb-3 pt-5 pb-4">
          ...
          <div className="col-sm-7 lead">
            <div id="carouselExampleDark" className="carousel carousel-dark slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="Images/PIS/dfd1.jpg" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src="Images/PIS/dfd2.jpg" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src="Images/PIS/dfd3.jpg" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src="Images/PIS/dfd4.jpg" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src="Images/PIS/dfd5.jpg" className="d-block w-100" alt="..." />
                </div>
              </div>
